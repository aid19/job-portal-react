  ...
  return (
    <div className='mb-[4rem] mt-[6rem]'>
      <h1 className='text-textColor text-[25px] py-[2rem] pb-[3rem] font-bold w-[400px] block'>
        ...
        <div className='card mt-[2rem] flex justify-between bg-greenColor p-[5rem] reounded[10px]'>
          <div>
            <h1 className='text-greenColor text-[30px] font-bold'>Ready to switch a career?</h1>
            <h2 className='text-textColor text-[25px] font-bold'>Let get started!</h2>
          </div>
