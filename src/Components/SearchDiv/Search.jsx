      ...
      <from action="">
        ...
        >
          <div className="flex gap-2 items-center">
            ...
            <input
              type="text"
              className="bg-transparent text-blue-500 focus:otline-none w-[100%]"
          ...
          <button className="bg-greenColor h-full p-5 px-10 rounded-[10px] text-white cursor-pointer hover:bg-blue-300">
            Search
          </button>
        </div>
      </from>
