    ...
    <div className='searchDiv grid gap-10 bg-greyIsh reounded-[10px] p-[3rem]'>
        <from action="">
            ...
            shadow-lg shadow-greyIsh-700'>
                ...
                <button className='bg-greenColor h-full p-5 px-10 rounded-[10px] text-white cursor-pointer hover:bg-blue-300'>Search</button>
            </div>
        </from>
        ...
        <div className="secDiv flex items-center gap-10 justify-center">
          ...
          <div className='singleSearch flex items-center gap-2'>
            ...
            <select name="" id="tyoe" className='bg-white rounded-[3px] px-4 py-1'>
